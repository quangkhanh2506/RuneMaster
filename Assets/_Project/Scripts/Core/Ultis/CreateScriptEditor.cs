...
public static class CreateScriptEditor
{
    public const string NameSpaceTemplate = "Templates/BaseUI";

    [MenuItem("Assets/Create/Create New Script/Base UI", priority = 0)]
    ...
    static void CreateFMScript(string assetTemplate, string defaultName)
    {
        ...
        CreateScriptAsset(AssetDatabase.GetAssetPath(t.GetInstanceID()), GetDestinPath() 
                                                                         + "/" + defaultName);
